# Predictive factors of acculturative stress among Latino/a/x/ and/or Hispanic college students
...
data/ = thesis dataset from survey 

code/ = analysis script from R 
...
## Data 
Data was collected from a survey that was posted on the Brooklyn College SONA website

## Code/Analysis
Data cleaning and analysis were done in R. Script could be found in the code/ folder
